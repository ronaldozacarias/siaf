					...
					<table id="ranking" class="table">
						<thead>
							<tr>
								<th>#</th>
								<th>Nome</th>
								<th><span data-toggle="popover" data-placement="top" data-content="Número de semestres desde a contratação na UFC até o início do afastamento">T</span></th>
								<th><span data-toggle="popover" data-placement="top" data-content="Número de semestres em que o docente já esteve afastado">A</span></th>
								<th><span data-toggle="popover" data-placement="top" data-content="Número de semestres do afastamento reservado/solicitado. No caso de primeiro afastamento, a variável S terá valor dois (2)">S</span></th>
								<th><span data-toggle="popover" data-placement="top" data-content="Número de semestres que faltam para o docente completar três (3) anos de contratação">P</span></th>
								<th><span data-toggle="popover" data-placement="top" data-content="Número de semestres solicitados">SS</span></th>
					            <th>Período</th>
