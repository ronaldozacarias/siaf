	...
	<div class="login-container" align="center">
		<div class="login-header">
			<img alt="Sistema de Afastamento de Professores"
				src="<c:url value="/resources/images/logo-beta.png" />">
		</div>
		...
		<div class="login-form">
			...
			<form:form role="form" servletRelativeAction="/j_spring_security_check" method="post"
				id="login-form" autocomplete="off" class="form-horizontal">
				...
				<c:if test="${not empty msg}">
					<div class="msg">
						<i class="fa fa-info-circle"></i>${msg}</div>
				</c:if>
				...
				<div class="form-group">
					<div id="inputLogin" class="form-inline input-group input-login">
						<span class="input-group-addon"><i class="fa fa-user"></i></span> <input type="text"
							name="j_username" id="cpf" class="form-control" placeholder="cpf" required="required">
					</div>
				</div>
				...
				<div style="text-align: center;">
					<button class="btn btn-siaf btn-login hvr-icon-forward" name="submit" type="submit"
						value="Login" value="Login">Login</button>
				</div>
			</form:form>
		</div>
	</div>
	<footer>
		<img id="logo-campus" alt="Campus da UFC em Quixadá"
			src="<c:url value="/resources/images/logo-npi.png" />">
		<p>
			Desenvolvido por <a href="http://www.npi.quixada.ufc.br" target="_blank">Núcleo de Práticas
				em Informática</a>
		</p>
