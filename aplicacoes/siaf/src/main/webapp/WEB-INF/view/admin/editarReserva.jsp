...
<div id="wrapper">
		...
		<div id="content">
			<div class="title">Editar reserva de afastamento :</div>
			<span class="line"></span>
			<form:form id="formEditarReserva" commandName="reserva" action="/siaf/administracao/editar-reserva"
					...
					<div class="form-item">
						...
						<div class="col-sm-4">
							<input id="anoTerminoReserva" type="text" name="anoTermino"  class="form-control" size="10"
								placeholder="ano" value="${reserva.anoTermino }" required="required"/>
